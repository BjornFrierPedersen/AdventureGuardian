...
public class CharacterTests
{
    ...
    public async Task Updating_character_background_succeed_with_valid_parameters()
    {
        ...
        // Act
        _characterService.GenerateCharacterBackstory(character, new[] {"test"});
        await _characterService.UpdateAsync(character, CancellationToken.None);
        // Assert
        var campaignAfterUpdate = await _campaignService.GetByIdAsync(campaignId, CancellationToken.None);
