...
public class CampaignService
{
    ...
    public async Task<Campaign> CreateAsync(CreateCampaignDto dto, CancellationToken cancellationToken)
    {
    ...
    public async Task<Campaign> GetByIdAsync(int id, CancellationToken cancellationToken)
    {
        return await _repository.GetCampaignByIdAsync(id, cancellationToken);
    }
    
    public async Task<Campaign> GetByIdAsync(Guid externalId, CancellationToken cancellationToken)
    {
        return await _repository.GetCampaignByExternalIdAsync(externalId, cancellationToken);
    }
